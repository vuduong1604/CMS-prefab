    ...
    execute: function () {
      ...
      _export("Item", Item = (_dec = ccclass("Item"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(EditBox), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(SpriteFrame), _dec(_class = (_class2 = class Item extends Component {
        ...
        getData() {
          ...
          ques.Text = find("ContentIMG/Mask/Sprite/Label_sprite", this.Questnode).getComponent(Label).string.replace(this.baseurl, ""); // anh cho keo position dien cau hoi
...
//# sourceMappingURL=7cfdf248bd2df2bad2869fb849c69a48378e0079.js.map