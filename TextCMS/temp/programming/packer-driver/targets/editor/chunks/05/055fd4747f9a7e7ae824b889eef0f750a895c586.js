System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "4ed5aL8hMNJIppvcD/sLQDw", "Item", undefined);
      ...
      _export("Item", Item = (_dec = ccclass("Item"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(EditBox), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(SpriteFrame), _dec(_class = (_class2 = class Item extends Component {
        constructor(...args) {
          super(...args);
        ...
        getData() {
          ...
          ques.Text = find("Sprite/Content", this.Questnode).getComponent(EditBox).string; // url content

          ques.Image = find("ContentIMG/Mask/Sprite/Label_sprite", this.Questnode).getComponent(Label).string.replace(this.baseurl, ""); // anh cho keo position dien cau hoi
          ...
          for (var i = 0; i < this.Index; i++) {
            ...
            ans.Image = find("Mask/Sprite/Label_sprite", this.AmountItem[i]).getComponent(Label).string.replace(this.baseurl, ""); // url img
        ...
        LoadData(jsondata) {
          ...
          for (var i = 0; i < deserializeJson.question.length; i++) {
            ...
            find("Content", this.Questnode).getComponent(EditBox).string = deserializeJson.question[i].Text; // load position
...
//# sourceMappingURL=055fd4747f9a7e7ae824b889eef0f750a895c586.js.map