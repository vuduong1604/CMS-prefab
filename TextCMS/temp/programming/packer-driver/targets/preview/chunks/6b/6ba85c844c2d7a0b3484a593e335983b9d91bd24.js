System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfItemShip(extras) {
    _reporterNs.report("ItemShip", "./ItemShip", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      ItemShip = _unresolved_3.ItemShip;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("Gamemanager", Gamemanager = (_dec = ccclass("Gamemanager"), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(SpriteFrame), _dec10 = property(SpriteFrame), _dec11 = property(Node), _dec(_class = (_class2 = class Gamemanager extends Component {
        constructor() {
          super(...arguments);

          _initializerDefineProperty(this, "Item", _descriptor, this);

          _initializerDefineProperty(this, "ItemShip", _descriptor2, this);

          _initializerDefineProperty(this, "BG", _descriptor3, this);

          _initializerDefineProperty(this, "noti", _descriptor4, this);

          _initializerDefineProperty(this, "popupupload", _descriptor5, this);

          _initializerDefineProperty(this, "button_tpnl", _descriptor6, this);

          _initializerDefineProperty(this, "ListItem", _descriptor7, this);

          _initializerDefineProperty(this, "disableSoundSprite", _descriptor8, this);

          _initializerDefineProperty(this, "enableSoundSprite", _descriptor9, this);

          _initializerDefineProperty(this, "sprBg", _descriptor10, this);
        ...
        loadData(data) {
          ...
          for (var i = 0; i < data.length; i++) {
            this.AddItem();
            this.ListItem[this.ListItem.length - 1].getComponent(_crd && ItemShip === void 0 ? (_reportPossibleCrUseOfItemShip({
              error: Error()
            }), ItemShip) : ItemShip).iditem.string = data[i].id;
            this.ListItem[this.ListItem.length - 1].getComponent(_crd && ItemShip === void 0 ? (_reportPossibleCrUseOfItemShip({
              error: Error()
            }), ItemShip) : ItemShip).LoadData(data[i].jsonData);
          }
        }
        /**
         * AddItem
        ...
        AddItem() {
          if (this.ListItem.length < this.maxpage) {
            ...
            a.parent = this.BG;
            a.getComponent(_crd && ItemShip === void 0 ? (_reportPossibleCrUseOfItemShip({
              error: Error()
            }), ItemShip) : ItemShip).PageName.string = this.i.toString();
            this.ListItem.push(a);
            this.ListItem.forEach(element => {
              console.log(element.getComponent(_crd && ItemShip === void 0 ? (_reportPossibleCrUseOfItemShip({
                error: Error()
              }), ItemShip) : ItemShip).PageName.string);
            });
          } else {
        ...
        Next() {
          ...
          this.ListItem.forEach(element => {
            if (element.active == true) {
              index = Number(element.getComponent(_crd && ItemShip === void 0 ? (_reportPossibleCrUseOfItemShip({
                error: Error()
              }), ItemShip) : ItemShip).PageName.string);
            }
          });
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "ItemShip", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "noti", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "popupupload", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "button_tpnl", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "ListItem", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "disableSoundSprite", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "enableSoundSprite", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "sprBg", [_dec11], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=6ba85c844c2d7a0b3484a593e335983b9d91bd24.js.map